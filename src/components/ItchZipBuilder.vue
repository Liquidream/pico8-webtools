<template>
  <h2 class="text-h4 pt-5">Itch.io Zip Builder</h2>
  <span class="text-body-1"
    >Paste in the URL of your creation (after doing
    <strong>SAVE @URL</strong> in PICO-8) and click to download a ZIP file which
    you can then upload to <a href="https://itch.io/">Itch.io</a> (e.g. to submit a jam entry).</span
  >
  <v-form ref="form">
    <v-text-field
      v-model="inputUrl"
